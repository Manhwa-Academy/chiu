        ...
        if (e.getSource() == btnSendMail) {
            ...
            if (email.equals("")) {
                ...
                if (matcher.matches() == false) {
                    ...
                    if (tk == null) {
                        ...
                        // Hiển thị thông báo sau khi gửi OTP
                        JOptionPane.showMessageDialog(this, "Mã OTP đã được gửi vào email của bạn", "Thông báo",
            ...
            if (otp.equals("")) {
                ...
                if (matcher.matches() == false) {
                    ...
                    if (check) {
                        CardLayout c = (CardLayout) jpMain.getLayout();
                        c.next(jpMain); // Di chuyển sang màn hình nhập mật khẩu mới
                    } else {
            ...
            if (pass.isEmpty()) {
                ...
                boolean isUpdated = TaiKhoanDAO.getInstance().updatePass(this.emailCheck, passwordHash);
                if (isUpdated) {
                    JOptionPane.showMessageDialog(this, "Thay đổi mật khẩu thành công");
                    this.dispose();
                } else {
                    JOptionPane.showMessageDialog(this, "Có lỗi xảy ra khi thay đổi mật khẩu");
                }
