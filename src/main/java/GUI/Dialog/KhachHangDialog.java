...
public class KhachHangDialog extends JDialog implements MouseListener {
    ...
    public void mousePressed(MouseEvent e) {
        if (e.getSource() == btnThem && Validation()) {
            ...
            Timestamp ngaythamgia = new Timestamp(System.currentTimeMillis()); // Gán ngày giờ hiện tại
            jpKH.khachhangBUS
                    .add(new DTO.KhachHangDTO(id, tenKH.getText(), sdtKH.getText(), diachiKH.getText(), ngaythamgia));
            jpKH.loadDataTable(jpKH.listkh);
            dispose();
        } else if (e.getSource() == btnHuyBo) {
            dispose();
        } else if (e.getSource() == btnCapNhat && Validation()) {
            jpKH.khachhangBUS.update(new KhachHangDTO(kh.getMaKH(), tenKH.getText(), sdtKH.getText(),
                    diachiKH.getText(), kh.getNgaythamgia()));
            jpKH.loadDataTable(jpKH.listkh);
            dispose();
        }
    }
