...
public final class ThuongHieuDialog extends JDialog implements MouseListener {
    ...
    public void mouseClicked(MouseEvent e) {
        if (e.getSource() == add) {
            ...
            if (index != -1) {
                String tenthuonghieu = ms.getText();
                // Kiểm tra xem tên có bị trùng lặp không
                if (Validation.isEmpty(tenthuonghieu)) {
                    JOptionPane.showMessageDialog(this, "Vui lòng nhập tên thương hiệu mới");
                } else {
                    // Kiểm tra trùng lặp với các thương hiệu khác
                    if (thBUS.checkDup(tenthuonghieu)) {
                        ...
                        JOptionPane.showMessageDialog(this, "Thương hiệu đã tồn tại vui lòng kiểm tra lại!");
                    }
                }
            }
        } else if (e.getSource() == table) {
            // Khi chọn một dòng trong bảng, điền tên thương hiệu vào ô nhập liệu
