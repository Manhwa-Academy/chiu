...
public class ThongKeDAO {
    ...
    public static HashMap<Integer, ArrayList<ThongKeTonKhoDTO>> getThongKeTonKho(String text, Date timeStart,
            Date timeEnd) {
        ...
        try {
            ...
            while (rs.next()) {
                ...
                // Tạo đối tượng ThongKeTonKhoDTO và thêm vào kết quả
                ThongKeTonKhoDTO p = new ThongKeTonKhoDTO(masp, maphienbansp, tensp, soluongdauky, soluongnhap,
                        soluongxuat, soluongcuoiky);
