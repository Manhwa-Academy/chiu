...
--
-- Máy chủ: 127.0.0.1
-- Thời gian đã tạo: Th2 13, 2026 lúc 09:21 AM
...
(1, 'Khách lẻ', 'a', '111111111', 1, '2026-02-11 20:24:54');
...
(2, 'Công ty Vivo Việt Nam', 'Số 79 đường số 6, Hưng Phước 4, Phú Mỹ Hưng, quận 7, TPHCM', 'contact@paviet.vn', '19009477', 0);
...
ALTER TABLE `giohang`
  ADD PRIMARY KEY (`id`),
  ADD UNIQUE KEY `unique_cart` (`manv`,`maphienbansp`),
  ADD KEY `fk_giohang_phienban` (`maphienbansp`);
...
--
ALTER TABLE `phienbansanpham`
  MODIFY `maphienbansp` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=13;
...
--
ALTER TABLE `phieuxuat`
  MODIFY `maphieuxuat` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=11;
...
--
ALTER TABLE `giohang`
  ADD CONSTRAINT `fk_giohang_nhanvien` FOREIGN KEY (`manv`) REFERENCES `nhanvien` (`manv`) ON DELETE CASCADE,
  ADD CONSTRAINT `fk_giohang_phienban` FOREIGN KEY (`maphienbansp`) REFERENCES `phienbansanpham` (`maphienbansp`) ON DELETE CASCADE;
